...
width=$3
height=$4
cvlc screen:// :screen-fps=30 :screen-caching=100 :screen-left=1600 --sout "#transcode{vcodec=h264,vb=4096,acodec=mpga,ab=256,scale=1,width=$3,height=$4‌​}:standard{access=http, mux=ts, dst=$1:$2} " 
fi
